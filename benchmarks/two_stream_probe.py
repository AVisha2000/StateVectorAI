...
Strict design: identical word transformer; sentence stream is quantum,
classical (param-matched, ~0.7% larger = conservative), or none (baseline).
Three conditioning modes (film/token/bias). Run on BOTH classical text and
...
def main() -> None:
    ...
    p.add_argument("--suite", default="two-stream-v1")
